                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        ...
                                        <h3 class="text-center font-weight-light my-4">Modification d'une annonce</h3></div>
                                    <div class="card-body">
                                        <form action="<?=ROOT?>/annonce/updateAnnonce/<?=$id?>" method="POST" enctype="multipart/form-data">
                                            <div class="row mb-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="titre" type="text" name="titre" value="<?=$titre?>" />
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="nombre_pieces" type="text" name="nombre_pieces" value="<?=$nombre_pieces ?>" />
                                                        <label for="nombre_pieces">Nombre de pièces</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="tarif_mensuel" type="text" name="tarif_mensuel" value="<?=$tarif_mensuel?>" />
                                             ...
                                             <div>
                                                ...
                                                <?php 
                                                echo "<img width = '50' src='".ROOT."/public/img/$image'>";
                                                ?>
